...
NNfirst <- function(w, k, subcentroids, subclusters, query_chunks, M, SqNorm) {
    .Call("_scmap_NNfirst", PACKAGE = "scmap", w, k, subcentroids, subclusters, query_chunks, M, 
        SqNorm)
}
...
NNmult <- function(w, k, subcentroids, subclusters, query_chunks, M, SqNorm, best_cells_so_far, best_distances_so_far, 
    dataset_inds, dat_num) {
    .Call("_scmap_NNmult", PACKAGE = "scmap", w, k, subcentroids, subclusters, query_chunks, M, SqNorm, 
        best_cells_so_far, best_distances_so_far, dataset_inds, dat_num)
}
