...
fsc3_merge_datasets <- function(object_reference, object_to_map, exprs_values = "exprs", 
    cell_type_name = "stage") {
    ...
    cell_type <- c(as.character(object_reference@phenoData@data[[cell_type_name]]), as.character(dat_to_map@phenoData@data$fsc3_buckets_assigned))
