...
tasic <- readRDS("~/data/tasic-rpkms.rds")
...
nestorowa <- readRDS("~/data/nestorowa.rds")

ee50 <- readRDS("~/Desktop/ee50.rds")
cc97 <- readRDS("~/Desktop/cc97.rds")
rc44 <- readRDS("~/Desktop/rc44.rds")
ca76 <- readRDS("~/Desktop/ca76.rds")
is76 <- readRDS("~/Desktop/is76.rds")
sw87 <- readRDS("~/Desktop/sw87.rds")
...
ref <- read.table("~/Desktop/refs/nestorowa.txt", check.names = FALSE, sep = "\t")

scmap_ref <- ee50
scmap_map <- kolodziejczyk
...
# create reference
scmap_ref <- scmap_ref[fData(scmap_ref)$scmap_features, ]
d <- createReference(scmap_ref)
write.table(d, "~/Desktop/refs/nestorowa.txt", quote = F, sep = "\t")
